                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url('/dzijas') }}" class="underline text-red-900 dark:text-gray">{{ __('messages.ATPAKAĻ UZ DZIJĀM') }}</a></div>
                            </div>        
                                <div class="py-12">
                                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                        <div class="p-6 bg-white border-b border-gray-200">
                                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('messages.Dzijas info') }}</h2>
                                        <p class='text-lg'><strong class='font-semibold'>{{ __('messages.Nosaukums') }}:</strong> {{ $dzija->nosaukums }}</p>
                                        <p class='text-lg'><strong class='font-semibold'>{{ __('messages.Ražotājs') }}:</strong> {{ $dzija->razotajs_id}}</p>
                                        <p class='text-lg'><strong class='font-semibold'>{{ __('messages.Garums') }}:</strong> {{ $dzija->garums }}</p>
                                        @isset($dzija->apraksts)
                                        <p class='text-lg'><strong class='font-semibold'>{{ __('messages.Apraksts') }}:</strong> {{ $dzija->apraksts }}</p>
                                        @endisset
                                    </div>
                                </div>
                            </div> 
