        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    value='{{ old('nosaukums', $dzija->nosaukums) }} 'class="form-control @error('nosaukums') is-invalid @enderror">
                        @error('nosaukums')
                ...
                value='{{ old('garums', $dzija->garums) }} 'class="form-control @error('garums') is-invalid @enderror">
                @error('garums')
                <span class="invalid-feedback">
                <strong>{{ $message }}</strong>
                </span>
