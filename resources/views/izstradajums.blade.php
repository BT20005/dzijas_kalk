                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="red" class="bi bi-flower1" viewBox="0 0 16 16">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url('/veids') }}" class="underline text-red-900 dark:text-gray">ATPAKAĻ UZ IZSTRĀDĀJUMIEM</a></div>
                            </div>        
                                <div class="py-12">
                                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                        <div class="p-6 bg-white border-b border-gray-200">
                                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Izstrādājuma info') }}</h2>
                                        <p class='text-lg'><strong class='font-semibold'>Nosaukums:</strong> {{ $izstradajums->nosaukums }}</p>
                                        <p class='text-lg'><strong class='font-semibold'>Izmērs:</strong> {{ $izstradajums->izmers}}</a></p>
                                        <p class='text-lg'><strong class='font-semibold'>Garums:</strong> {{ $izstradajums->garums }}</p>
                                        @isset($izstradajums->apraksts)
                                        <p class='text-lg'><strong class='font-semibold'>Apraksts:</strong> {{ $izstradajums->apraksts }}</p>
                                        @endisset
                                    </div>
                                </div>
                            </div> 
